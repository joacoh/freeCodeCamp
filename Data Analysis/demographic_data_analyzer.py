...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(len(df[df.education=='Bachelors'].age)/len(df.age)*100, 1)
    ...
    higher_education_rich = round(len(higher_education[higher_education.salary=='>50K'].age)/len(higher_education.age)*100,1)
    lower_education_rich = round(len(lower_education[lower_education.salary=='>50K'].age)/len(lower_education.age)*100,1)
